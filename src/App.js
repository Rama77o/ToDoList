  ...
  return (
    <div className="App container">
      ...
      <div className="three">
        ...
        <button className="btn btn-[#afeeee]" onClick={removeAllComleteToDo}>
          remove all complete todos
        </button>
        <button className="btn btn-[#afeeee]" onClick={removeActiveToDo}>
          remove all active todos
        </button>
        <button
          className="btn btn-[#afeeee]"
          onClick={() => {
